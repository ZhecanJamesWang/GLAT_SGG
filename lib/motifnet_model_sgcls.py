        ...
        if self.training:
            ...
            if self.return_top100:
                ...
                for i in range(len(rel_ind_per_img)):
                    ...
                    (boxes, obj_classes, obj_scores, rels_b_100, pred_scores_sorted_b_100, rels_a_100, \
                    pred_scores_sorted_a_100, rel_scores_idx_b_100, rel_scores_idx_a_100, rel_dists_b, rel_dists_a, ent_dists) = filter_dets(bboxes, result.obj_scores,
