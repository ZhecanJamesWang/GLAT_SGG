...
# file1 = "results/kern_rel_recall_sgcls_2020_0312_1420.pkl"
# file2 = "results/kern_rel_recall_sgcls_2020_0312_1400.pkl"

file1 = "results/kern_rel_recall_sgcls_2020_0312_1633.pkl"
file2 = "results/kern_rel_recall_sgcls_2020_0312_1622.pkl"
...
def draw_scatter():
    ...
    for r in rel_list:
        cvpr18_list.append(cvpr18[r]['R@100'])
        our_list.append(our[r]['R@100'])
...
def draw_difference_compare():
    # file = "results/kern_rel_recall_predcls_2020_0307_1752.pkl"
    with open(file1, 'rb') as f:
        cvpr18 = pickle.load(f)
    with open(file2, 'rb') as f:
        our = pickle.load(f)
    ...
    plt.ylabel('R@100 Improvement (%)', fontsize=14)
