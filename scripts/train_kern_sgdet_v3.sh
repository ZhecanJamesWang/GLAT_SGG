#!/usr/bin/env bash
python models/train_rels_glat_universal_v3.py -m sgdet -p 500 -clip 5 -model_s_m kern \
-tb_log_dir summaries/train_glat_kern_sgdet_v31 \
-save_dir checkpoints/train_glat_kern_sgdet_v31 \
...
| tee ./logs/train_glat_kern_sgdet_v31.txt \
