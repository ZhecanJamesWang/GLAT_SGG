#!/usr/bin/env bash
python models/kern_bal.py -m sgcls -p 400 -clip 5 \
-tb_log_dir summaries/kern_bal_sgcls_onlypred \
-save_dir checkpoints/kern_bal_sgcls_onlypred \
...
| tee ./logs/train_kern_bal_sgcls_onlypred.txt