...
python models/eval_stanford_motif_glat_mask_logit_thres_v2.py -m predcls -model_s_m motifnet -b 1 -clip 5 \
    -p 100 -pooling_dim 4096 -lr 1e-3 -ngpu 1 -test -ckpt checkpoints/motifnet/vgrel-motifnet-sgcls.tar -nepoch 50 -cache ./cache/motifnet_glat_predcls_mask_logit_thres_fintuned_v2 | tee ./logs/eval_motif_glat_predcls_mask_logit_thres_fintuned_v2.txt
