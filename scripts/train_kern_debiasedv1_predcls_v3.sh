...
-tb_log_dir summaries/train_glat_kern_debiasedv1_predcls_v31 \
-save_dir checkpoints/train_glat_kern_debiasedv1_predcls_v31 \
...
| tee ./logs/train_glat_kern_debiasedv1_predcls_v31.txt \
