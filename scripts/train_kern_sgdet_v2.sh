#!/usr/bin/env bash
python models/train_rels_glat_universal.py -m sgdet -p 500 -clip 5 -model_s_m kern \
-tb_log_dir summaries/train_glat_kern_sgdet_v2 \
-save_dir checkpoints/train_glat_kern_sgdet_v2 \
...
| tee ./logs/train_glat_kern_sgdet_v2.txt \
