#!/usr/bin/env bash
python models/train_rels_glat_universal.py -m predcls -p 400  -model_s_m kern -clip 5  \
-tb_log_dir summaries/train_glat_kern_predcls_v2 \
-save_dir checkpoints/train_glat_kern_predcls_v2 \
...
| tee ./logs/train_glat_kern_predcls_v2.txt \
