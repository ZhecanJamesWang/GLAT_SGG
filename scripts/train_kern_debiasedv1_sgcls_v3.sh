#!/usr/bin/env bash
python models/train_rels_glat_universal_v3.py -m sgcls -p 400  -model_s_m kern -clip 5  \
-tb_log_dir summaries/train_glat_kern_debiasedv1_sgcls_v31 \
-save_dir checkpoints/train_glat_kern_debiasedv1_sgcls_v31 \
...
| tee ./logs/train_glat_kern_debiasedv1_sgcls_v31.txt \
