...
python models/eval_stanford_motif_glat_mask.py -m predcls -model_s_m stanford -b 1 -clip 5 \
    -p 100 -pooling_dim 4096 -lr 1e-3 -ngpu 1 -test -ckpt checkpoints/stanford_1/vgrel-7.tar -nepoch 50 -cache ./cache/stanford_glat_predcls_mask_pretrained | tee ./logs/eval_stanford_glat_predcls_mask_pretrained_1.txt