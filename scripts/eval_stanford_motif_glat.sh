...
#echo "EVALING MOTIFNET"
#python models/eval_stanford_motif.py -m sgcls -model_s_m motifnet -b 6 -clip 5 \
#    -p 100 -pooling_dim 4096 -lr 1e-3 -ngpu 1 -test -ckpt checkpoints/motifnet/vgrel-motifnet-sgcls.tar -nepoch 50 -cache ./cache/motifnet_sgcls | tee eval_motif.txt
#
#echo "EVALING MOTIFNET_GLAT"
#python models/eval_stanford_motif_glat.py -m sgcls -model_s_m motifnet -b 6 -clip 5 \
#    -p 100 -pooling_dim 4096 -lr 1e-3 -ngpu 1 -test -ckpt checkpoints/motifnet/vgrel-motifnet-sgcls.tar -nepoch 50 -cache ./cache/motifnet_glat | tee eval_motif_glat.txt
#


echo "EVALING STANFORD"
python models/eval_stanford_motif.py -m sgcls -model_s_m stanford -b 6 -clip 5 -p 100 -pooling_dim 4096 -lr 1e-3 -ngpu 1 -test -ckpt checkpoints/stanford_1/vgrel-7.tar -nepoch 50 -cache ./cache/stanford_sgcls | tee eval_stanford.txt


echo "EVALING STANFORD_GLAT"
python models/eval_stanford_motif_glat.py -m sgcls -model_s_m stanford -b 1 -clip 5  -p 100 -pooling_dim 4096 -lr 1e-3 -ngpu 1 -test -ckpt checkpoints/stanford_1/vgrel-7.tar -nepoch 50 -cache ./cache/stanford_glat  | tee eval_stanford_glat.txt
